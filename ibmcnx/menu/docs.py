...
doc.AddItem( 'Check JVM Heap Sizes (ibmcnx/doc/JVMHeap.py)', ibmcnx.functions.docJVMHeap )
doc.AddItem( 'Check JVM Heap Sizes (ibmcnx/doc/JVMSettings.py)', ibmcnx.functions.docJVMSettings )
doc.AddItem( 'Check SystemOut/Err Log Sizes (ibmcnx/doc/LogFiles.py)', ibmcnx.functions.docLogFiles )
doc.AddItem( 'Check / Show all used ports (ibmcnx/doc/Ports.py)', ibmcnx.functions.docPorts )
doc.AddItem( 'Check / Show all used ports (ibmcnx/doc/Variables.py)', ibmcnx.functions.docVariables )
