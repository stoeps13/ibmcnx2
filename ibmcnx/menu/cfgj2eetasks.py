...
cfgj2ee.AddItem('Set J2EE Role for Metrics Reader (ibmcnx/config/J2EERoleMetricsReader.py)',
                ibmcnx.functions.cfgJ2EERoleMetricsReader)
cfgj2ee.AddItem('Set J2EE Role for Metrics Report Run (ibmcnx/config/J2EERoleMetricsReportRun)',
                ibmcnx.functions.cfgJ2EERoleMetricsReportRun)
cfgj2ee.AddItem('Set J2EE Role for SocialMail (ibmcnx/config/J2EERoleSocialMail)',
                ibmcnx.functions.cfgJ2EERoleSocialMail)
cfgj2ee.AddItem('Back to Main Menu (cnxmenu.py)',
