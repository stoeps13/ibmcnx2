...
def webserverstatus( cellname, nodename, wsname):
    ...
    objNameString = AdminControl.completeObjectName( 'WebSphere:type=WebServer,name=WebServer,*') 
...
for webserver in webservers:
    ...
    objNameString = AdminControl.completeObjectName( 'WebSphere:type=WebServer,name=' + webserverName + ',*' )
